...
(defun result (puzzle action)
    (cond 
        ...
        ((eq action :left) ((setq temp (aref puzzle (colN (- rowN 1))))
                            (setq (aref puzzle colN rowN) temp)
                            (setq (aref puzzle colN (- rowN 1)) nil)
                            )
        )
        ...
        ;;movement for going up and down
        ((eq action :down) ((setq temp (aref puzzle ((+ colN 1) rowN)))
                            (setq (aref puzzle colN rowN) temp)
                            (setq (aref puzzle (+ colN 1) rowN) nil)
                            )
        )
        ((eq action :up) ((setq temp (aref puzzle ((- colN 1) rowN)))
                            (setq (aref puzzle colN rowN) temp)
                            (setq (aref puzzle (- colN 1) rowN) nil)
                            )
        )
